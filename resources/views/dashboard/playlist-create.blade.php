...
@section('content')
        ...
        <div class="card card-primary">
            ...
            <!-- /.card-header -->
            <!-- form start -->
            <form action="{{route('dashboard.playlist.store')}}" method="post" enctype="multipart/form-data">
                @csrf
                <div class="card-body">
                    <div class="form-group">
                        <label for="exampleInputEmail1">playlist Name</label>
                        <input type="text" class="form-control" id="exampleInputEmail1" name="name" placeholder="Enter Playlist Title">
                    </div>
                    <div class="form-group">
                        <label for="exampleInputEmail1">playlist Category</label>
                        <input type="text" class="form-control" id="exampleInputEmail1" name="category" placeholder="Enter Playlist category">
                    </div>
                    <div class="form-group">
                        <label for="exampleInputPassword1">playlist Content</label>
                        <input type="text" class="form-control" id="exampleInputPassword1" name="content" placeholder="Enter Playlist Content">
                    </div>
                    <div class="form-group">
