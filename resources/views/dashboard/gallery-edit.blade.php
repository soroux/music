            ...
            <form action="{{route('dashboard.gallery.update',$gallery->id)}}" method="post" enctype="multipart/form-data">
                ...
                <div class="card-body">
                    <div class="form-group">
                        ...
                        <input type="text" class="form-control" id="exampleInputEmail1" name="name" value="{{$gallery->name}}">
                    </div>
                    <div class="form-group">
                        <label for="exampleInputEmail1">gallery title</label>
                        <input type="text" class="form-control" id="exampleInputEmail1" name="title" value="{{$gallery->title}}">
                    </div>
                    <div class="form-group">
                        <label for="exampleInputPassword1">gallery Content</label>
                        <input type="text" class="form-control" id="exampleInputPassword1" name="content" value="{{$gallery->content}}">
                    </div>
                    <div class="form-group">
