                ...
                <div class="single-post nobottommargin">
                    <div class="col-lg-12">
                        <div class="heading-block noborder dark" style="margin-bottom: 15px;">
                            <h3>Just listen</h3>
                            <span>Try not to controll the music ;D</span>
                        </div>
                                    ...
                                    <div class="entry clearfix">
                                        ...
                                        <div class="entry-c">
                                            <div class="entry-title">
                                                <h2><a href="{{route('index.playlist.show',$playlist)}}">{{$playlist->name}}</a></h2>
                                            </div>
                                            <ul class="entry-meta clearfix">
                                                <li><i class="icon-calendar3"></i>{{$playlist->created_at}}</li>
                                                <li><a href="#"><i class="icon-user"></i> {{$playlist->user->name}}</a></li>
                                                <li><i class="icon-folder-open"></i> <a href="#">{{$playlist->category}}</a></li>
